...
#        position = -1
#        first_element = True
#        for sequence in kfasta.subsequences(seq,k):
#            if first_element == True:
#                r_hash = RollingHash(sequence)
#                first_element = False
#            else:
#                new = sequence[k-1]
#                r_hash.slide(old,new)
#            position += 1
#            yield (sequence, r_hash.current_hash, position)
#            old = sequence[k-1]
#    raise Exception("Not implemented!")
...
#    if m<k:
#        raise Exception("m should be larger than k")
#        for s in subsequenceHashes(seq,k):
#            yield s
#    else:
        subseq = ''
        position = -1
